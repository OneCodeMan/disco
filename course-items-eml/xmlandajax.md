...
<text>
XML documents begin with an XML declaration, which identifies the document as an XML document.
</text>
<code>
&lt;?xml version="1.0"?&gt;
</code>
...
<section>
<title>Exstensible Stylesheet Language</title>
<text>
XSL (Extensible Stylesheet Language) stylesheets can be connected to an XML document by adding `xml:stylesheet` processing instruction to the XML document. They convert XML into any text-based document.
</text>
</section>
